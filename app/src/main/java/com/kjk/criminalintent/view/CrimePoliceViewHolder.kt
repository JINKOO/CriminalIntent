...
//        val crime = dataSender.getCrimeList().value!![position]
...
//        Toast.makeText(binding.root.context, "call police cause of ${dataSender.getCrimeList().value!![adapterPosition].title}", Toast.LENGTH_SHORT).show()
//    }
//
